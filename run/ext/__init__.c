...
#endif
#include <math.h>
#define __PYX_HAVE__ext____init__
#define __PYX_HAVE_API__ext____init__
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'ext.__init__' */
#define __Pyx_MODULE_NAME "ext.__init__"
int __pyx_module_is_main_ext____init__ = 0;

/* Implementation of 'ext.__init__' */
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_ext____init__) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  if (unlikely(__Pyx_SetPackagePathFromImportLib(NULL, __pyx_n_u_ext) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  #if PY_MAJOR_VERSION >= 3
  {
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init ext.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init ext.__init__");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
